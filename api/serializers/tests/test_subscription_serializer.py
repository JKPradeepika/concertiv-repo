...
class TestGetActiveEmployeeLicenseCount:
    def test_no_employee_licenses_zero(
        ...
        license_period_factory(subscription=subscription)
        assert SubscriptionSerializer.get_active_employee_license_count(subscription) == 0
    ...
    def test_null_el_start_end_one(
        ...
        assert SubscriptionSerializer.get_active_employee_license_count(subscription) == 1
