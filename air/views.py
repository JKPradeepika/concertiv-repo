...
class ProcessDataView(BasicView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if os.path.exists(csv_file_path):
            ...
            non_airport_codes = ["RTE-2V", "NYP-2V", "PHL-2V", "SEAAV", "BBY-2V", "PVD-2V", "HUD-2V", "WAS-2V", "XXX","BOS-2V", "STM-2V"]
            ...
            cursor.execute("SELECT prefered_airline FROM air_preference WHERE customer_name = '{0}'".format(customer_name))
            prefered_airline_data = cursor.fetchall()
...
class GraphsView(TemplateView):
    ...
    def post(self, request):
        ...
        return render(request, 'air/get_graphs.html', context)
