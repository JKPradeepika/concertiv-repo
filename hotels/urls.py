...
from .views import RawDataView, LoadRawDataView, FuzzyMatchView, CTVGroupSavingsCalculationView
...
urlpatterns = [
    ...
    path('travel/hotels/savings_calculation', CTVGroupSavingsCalculationView.as_view(), name='savings_calculation'),
]